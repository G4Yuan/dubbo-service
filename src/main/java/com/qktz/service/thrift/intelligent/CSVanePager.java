...
public class CSVanePager implements org.apache.thrift.TBase<CSVanePager, CSVanePager._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("CSVanePager");
  ...
  static {
    schemes.put(StandardScheme.class, new CSVanePagerStandardSchemeFactory());
    schemes.put(TupleScheme.class, new CSVanePagerTupleSchemeFactory());
  }
  ...
  public List<ChinaStocksVane> records; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(CSVanePager.class, metaDataMap);
  }
   ...
   */
  public CSVanePager(CSVanePager other) {
    ...
    if (other.isSetRecords()) {
      List<ChinaStocksVane> __this__records = new ArrayList<ChinaStocksVane>();
      for (ChinaStocksVane other_element : other.records) {
        __this__records.add(new ChinaStocksVane(other_element));
      }
  ...
  public CSVanePager deepCopy() {
    return new CSVanePager(this);
  }
  ...
  public CSVanePager setPageNow(int pageNow) {
    this.pageNow = pageNow;
    setPageNowIsSet(true);
    return this;
  }
  ...
  public CSVanePager setPageSize(int pageSize) {
    this.pageSize = pageSize;
    setPageSizeIsSet(true);
    return this;
  }
  ...
  public CSVanePager setRecordSize(int recordSize) {
    this.recordSize = recordSize;
    setRecordSizeIsSet(true);
    return this;
  }
  ...
  public CSVanePager setPageNum(int pageNum) {
    this.pageNum = pageNum;
    setPageNumIsSet(true);
    return this;
  }
  ...
  public java.util.Iterator<ChinaStocksVane> getRecordsIterator() {
    return (this.records == null) ? null : this.records.iterator();
  }

  public void addToRecords(ChinaStocksVane elem) {
    if (this.records == null) {
      this.records = new ArrayList<ChinaStocksVane>();
    }
    this.records.add(elem);
  }

  public List<ChinaStocksVane> getRecords() {
    return this.records;
  }

  public CSVanePager setRecords(List<ChinaStocksVane> records) {
    this.records = records;
    return this;
  }
  ...
  public CSVanePager setHasNext(int hasNext) {
    this.hasNext = hasNext;
    setHasNextIsSet(true);
    return this;
  }
  ...
  public CSVanePager setHasPrev(int hasPrev) {
    this.hasPrev = hasPrev;
    setHasPrevIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case RECORDS:
      if (value == null) {
        ...
        setRecords((List<ChinaStocksVane>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof CSVanePager)
      return this.equals((CSVanePager)that);
    return false;
  }

  public boolean equals(CSVanePager that) {
    if (that == null)
      return false;
  ...
  public int compareTo(CSVanePager other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    CSVanePager typedOther = (CSVanePager)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("CSVanePager(");
    boolean first = true;
  ...
  private static class CSVanePagerStandardSchemeFactory implements SchemeFactory {
    public CSVanePagerStandardScheme getScheme() {
      return new CSVanePagerStandardScheme();
    }
  }

  private static class CSVanePagerStandardScheme extends StandardScheme<CSVanePager> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, CSVanePager struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.records = new ArrayList<ChinaStocksVane>(_list0.size);
                for (int _i1 = 0; _i1 < _list0.size; ++_i1)
                {
                  ChinaStocksVane _elem2; // required
                  _elem2 = new ChinaStocksVane();
                  _elem2.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CSVanePager struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.records != null) {
        oprot.writeFieldBegin(RECORDS_FIELD_DESC);
        {
          ...
          for (ChinaStocksVane _iter3 : struct.records)
          {
            _iter3.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class CSVanePagerTupleSchemeFactory implements SchemeFactory {
    public CSVanePagerTupleScheme getScheme() {
      return new CSVanePagerTupleScheme();
    }
  }

  private static class CSVanePagerTupleScheme extends TupleScheme<CSVanePager> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, CSVanePager struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetRecords()) {
        {
          ...
          for (ChinaStocksVane _iter4 : struct.records)
          {
            _iter4.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, CSVanePager struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.records = new ArrayList<ChinaStocksVane>(_list5.size);
          for (int _i6 = 0; _i6 < _list5.size; ++_i6)
          {
            ChinaStocksVane _elem7; // required
            _elem7 = new ChinaStocksVane();
            _elem7.read(iprot);
