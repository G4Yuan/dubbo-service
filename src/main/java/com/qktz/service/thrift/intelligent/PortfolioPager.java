...
public class PortfolioPager implements org.apache.thrift.TBase<PortfolioPager, PortfolioPager._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("PortfolioPager");
  ...
  static {
    schemes.put(StandardScheme.class, new PortfolioPagerStandardSchemeFactory());
    schemes.put(TupleScheme.class, new PortfolioPagerTupleSchemeFactory());
  }
  ...
  public List<PortfolioInfo> records; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(PortfolioPager.class, metaDataMap);
  }

  public PortfolioPager() {
  }
   ...
   */
  public PortfolioPager(PortfolioPager other) {
    ...
    if (other.isSetRecords()) {
      List<PortfolioInfo> __this__records = new ArrayList<PortfolioInfo>();
      for (PortfolioInfo other_element : other.records) {
        __this__records.add(new PortfolioInfo(other_element));
      }
  ...
  public PortfolioPager deepCopy() {
    return new PortfolioPager(this);
  }
  ...
  public PortfolioPager setPageNow(int pageNow) {
    this.pageNow = pageNow;
    setPageNowIsSet(true);
    return this;
  }
  ...
  public PortfolioPager setPageSize(int pageSize) {
    this.pageSize = pageSize;
    setPageSizeIsSet(true);
    return this;
  }
  ...
  public PortfolioPager setRecordSize(int recordSize) {
    this.recordSize = recordSize;
    setRecordSizeIsSet(true);
    return this;
  }
  ...
  public PortfolioPager setPageNum(int pageNum) {
    this.pageNum = pageNum;
    setPageNumIsSet(true);
    return this;
  }
  ...
  public java.util.Iterator<PortfolioInfo> getRecordsIterator() {
    return (this.records == null) ? null : this.records.iterator();
  }

  public void addToRecords(PortfolioInfo elem) {
    if (this.records == null) {
      this.records = new ArrayList<PortfolioInfo>();
    }
    this.records.add(elem);
  }

  public List<PortfolioInfo> getRecords() {
    return this.records;
  }

  public PortfolioPager setRecords(List<PortfolioInfo> records) {
    this.records = records;
    return this;
  }
  ...
  public PortfolioPager setHasNext(int hasNext) {
    this.hasNext = hasNext;
    setHasNextIsSet(true);
    return this;
  }
  ...
  public PortfolioPager setHasPrev(int hasPrev) {
    this.hasPrev = hasPrev;
    setHasPrevIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case RECORDS:
      if (value == null) {
        ...
        setRecords((List<PortfolioInfo>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof PortfolioPager)
      return this.equals((PortfolioPager)that);
    return false;
  }

  public boolean equals(PortfolioPager that) {
    if (that == null)
      return false;
  ...
  public int compareTo(PortfolioPager other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    PortfolioPager typedOther = (PortfolioPager)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("PortfolioPager(");
    boolean first = true;
  ...
  private static class PortfolioPagerStandardSchemeFactory implements SchemeFactory {
    public PortfolioPagerStandardScheme getScheme() {
      return new PortfolioPagerStandardScheme();
    }
  }

  private static class PortfolioPagerStandardScheme extends StandardScheme<PortfolioPager> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, PortfolioPager struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.records = new ArrayList<PortfolioInfo>(_list80.size);
                for (int _i81 = 0; _i81 < _list80.size; ++_i81)
                {
                  PortfolioInfo _elem82; // required
                  _elem82 = new PortfolioInfo();
                  _elem82.read(iprot);
                  struct.records.add(_elem82);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PortfolioPager struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.records != null) {
        oprot.writeFieldBegin(RECORDS_FIELD_DESC);
        {
          ...
          for (PortfolioInfo _iter83 : struct.records)
          {
            _iter83.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class PortfolioPagerTupleSchemeFactory implements SchemeFactory {
    public PortfolioPagerTupleScheme getScheme() {
      return new PortfolioPagerTupleScheme();
    }
  }

  private static class PortfolioPagerTupleScheme extends TupleScheme<PortfolioPager> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, PortfolioPager struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetRecords()) {
        {
          ...
          for (PortfolioInfo _iter84 : struct.records)
          {
            _iter84.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, PortfolioPager struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.records = new ArrayList<PortfolioInfo>(_list85.size);
          for (int _i86 = 0; _i86 < _list85.size; ++_i86)
          {
            PortfolioInfo _elem87; // required
            _elem87 = new PortfolioInfo();
            _elem87.read(iprot);
            struct.records.add(_elem87);
          }
        }
        struct.setRecordsIsSet(true);
      }
