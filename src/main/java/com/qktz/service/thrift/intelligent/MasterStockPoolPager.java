...
public class MasterStockPoolPager implements org.apache.thrift.TBase<MasterStockPoolPager, MasterStockPoolPager._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("MasterStockPoolPager");
  ...
  static {
    schemes.put(StandardScheme.class, new MasterStockPoolPagerStandardSchemeFactory());
    schemes.put(TupleScheme.class, new MasterStockPoolPagerTupleSchemeFactory());
  }
  ...
  public List<BaseMasterStockPool> records; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.RECORDS, new org.apache.thrift.meta_data.FieldMetaData("records", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, BaseMasterStockPool.class))));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(MasterStockPoolPager.class, metaDataMap);
  }

  public MasterStockPoolPager() {
  }
  ...
  public MasterStockPoolPager(
    ...
    int recordSize,
    int pageNum,
    List<BaseMasterStockPool> records,
    int hasNext,
    int hasPrev)
  {
    this();
   ...
   */
  public MasterStockPoolPager(MasterStockPoolPager other) {
    ...
    if (other.isSetRecords()) {
      List<BaseMasterStockPool> __this__records = new ArrayList<BaseMasterStockPool>();
      for (BaseMasterStockPool other_element : other.records) {
        __this__records.add(new BaseMasterStockPool(other_element));
      }
  ...
  public MasterStockPoolPager deepCopy() {
    return new MasterStockPoolPager(this);
  }
  ...
  public MasterStockPoolPager setPageNow(int pageNow) {
    this.pageNow = pageNow;
    setPageNowIsSet(true);
    return this;
  }
  ...
  public MasterStockPoolPager setPageSize(int pageSize) {
    this.pageSize = pageSize;
    setPageSizeIsSet(true);
    return this;
  }
  ...
  public MasterStockPoolPager setRecordSize(int recordSize) {
    this.recordSize = recordSize;
    setRecordSizeIsSet(true);
    return this;
  }
  ...
  public MasterStockPoolPager setPageNum(int pageNum) {
    this.pageNum = pageNum;
    setPageNumIsSet(true);
    return this;
  }
  ...
  public java.util.Iterator<BaseMasterStockPool> getRecordsIterator() {
    return (this.records == null) ? null : this.records.iterator();
  }

  public void addToRecords(BaseMasterStockPool elem) {
    if (this.records == null) {
      this.records = new ArrayList<BaseMasterStockPool>();
    }
    this.records.add(elem);
  }

  public List<BaseMasterStockPool> getRecords() {
    return this.records;
  }

  public MasterStockPoolPager setRecords(List<BaseMasterStockPool> records) {
    this.records = records;
    return this;
  }
  ...
  public MasterStockPoolPager setHasNext(int hasNext) {
    this.hasNext = hasNext;
    setHasNextIsSet(true);
    return this;
  }
  ...
  public MasterStockPoolPager setHasPrev(int hasPrev) {
    this.hasPrev = hasPrev;
    setHasPrevIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case RECORDS:
      if (value == null) {
        ...
        setRecords((List<BaseMasterStockPool>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof MasterStockPoolPager)
      return this.equals((MasterStockPoolPager)that);
    return false;
  }

  public boolean equals(MasterStockPoolPager that) {
    if (that == null)
      return false;
  ...
  public int compareTo(MasterStockPoolPager other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    MasterStockPoolPager typedOther = (MasterStockPoolPager)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("MasterStockPoolPager(");
    boolean first = true;
  ...
  private static class MasterStockPoolPagerStandardSchemeFactory implements SchemeFactory {
    public MasterStockPoolPagerStandardScheme getScheme() {
      return new MasterStockPoolPagerStandardScheme();
    }
  }

  private static class MasterStockPoolPagerStandardScheme extends StandardScheme<MasterStockPoolPager> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, MasterStockPoolPager struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.records = new ArrayList<BaseMasterStockPool>(_list64.size);
                for (int _i65 = 0; _i65 < _list64.size; ++_i65)
                {
                  BaseMasterStockPool _elem66; // required
                  _elem66 = new BaseMasterStockPool();
                  _elem66.read(iprot);
                  struct.records.add(_elem66);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, MasterStockPoolPager struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.records != null) {
        oprot.writeFieldBegin(RECORDS_FIELD_DESC);
        {
          ...
          for (BaseMasterStockPool _iter67 : struct.records)
          {
            _iter67.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class MasterStockPoolPagerTupleSchemeFactory implements SchemeFactory {
    public MasterStockPoolPagerTupleScheme getScheme() {
      return new MasterStockPoolPagerTupleScheme();
    }
  }

  private static class MasterStockPoolPagerTupleScheme extends TupleScheme<MasterStockPoolPager> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, MasterStockPoolPager struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetRecords()) {
        {
          ...
          for (BaseMasterStockPool _iter68 : struct.records)
          {
            _iter68.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, MasterStockPoolPager struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.records = new ArrayList<BaseMasterStockPool>(_list69.size);
          for (int _i70 = 0; _i70 < _list69.size; ++_i70)
          {
            BaseMasterStockPool _elem71; // required
            _elem71 = new BaseMasterStockPool();
            _elem71.read(iprot);
            struct.records.add(_elem71);
          }
        }
        struct.setRecordsIsSet(true);
      }
